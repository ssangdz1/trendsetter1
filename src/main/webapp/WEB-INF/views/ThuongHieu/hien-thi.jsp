...
<div class="container mt-4">
    <h1 class="text-center mb-3">Quản lý Thương Hiệu</h1>
        ...
        <div class="border p-3">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-striped text-center align-middle">
                    ...
                    <tbody>
                    <c:forEach items="${danhSach}" var="thuongHieu" varStatus="status">
                        <tr>
                            ...
                            <td>
                                ...
                                <button class="btn btn-warning btn-sm" data-bs-toggle="modal"
                                        data-bs-target="#suaModal-${thuongHieu.id}">
                                    <i class="bi bi-pencil-square"></i> Sửa
                                </button>
                                <!-- Nút xóa -->
                                <form action="/thuong-hieu/delete" method="post"
                        ...
                        <div class="modal fade" id="suaModal-${thuongHieu.id}" tabindex="-1"
                             aria-labelledby="suaModalLabel-${thuongHieu.id}" aria-hidden="true">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form action="/thuong-hieu/update" method="post">
                                            <input type="hidden" name="id" value="${thuongHieu.id}">
                                            <div class="mb-3">
                                                <label for="tenThuongHieu-${thuongHieu.id}" class="form-label">Tên
                                                    Thương
                                                    Hiệu</label>
                                                <input type="text" class="form-control"
                                                       id="tenThuongHieu-${thuongHieu.id}"
                                                       name="tenThuongHieu" value="${thuongHieu.tenThuongHieu}"
                                                       required>
                                            </div>
