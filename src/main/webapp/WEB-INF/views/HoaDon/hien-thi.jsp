        ...
        <div class="border p-3">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-striped text-center align-middle">
                    ...
                    <tbody>
                    <c:forEach items="${danhSach}" var="hoaDon" varStatus="status">
                        <tr>
                            <td>${status.index+1}</td>
                            <td>${hoaDon.khachHang.hoTen}</td>
                            <td>${hoaDon.nhanVien.tenNhanVien}</td>
                            <td>${hoaDon.khuyenMai.tenChuongTrinh}</td>
                            <td>${hoaDon.tongTien}</td>
                            <td>Ngày Tạo : ${hoaDon.ngayTao}<br>
                                Ngày Sửa : ${hoaDon.ngaySua}</td>
                            <td>${hoaDon.phuongThucThanhToan.tenPhuongThuc}</td>
                            <td>
                            ...
                            <td>
                                ...
                                <form action="/hoa-don/delete" method="post"
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="detailModalLabel-${hoaDon.id}">Chi Tiết Hóa Đơn</h5>
                                                ...
                                                <div class="card-body">
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-6">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                   value="${hoaDon.nhanVien.tenNhanVien}" readonly>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-3">
                                                        <div class="col-6">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                   value="${hoaDon.khuyenMai.tenKhuyenMai}" readonly>
                                                        </div>
                                                        <div class="col-6">
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header bg-warning text-white">
                                        <h5 class="modal-title" id="suaTrangThaiModalLabel-${hoaDon.id}">Cập Nhật Trạng
                                            Thái</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        <form action="/hoa-don/update-trang-thai" method="post">
                                            <input type="hidden" name="id" value="${hoaDon.id}">
