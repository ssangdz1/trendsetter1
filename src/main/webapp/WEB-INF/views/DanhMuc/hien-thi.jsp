...
<div class="container mt-4">
    <h1 class="text-center mb-3">Quản lý Danh Mục</h1>
    ...
    <div class="container mt-5">
        <div class="border p-3">
            ...
            <table class="table table-bordered table-striped text-center align-middle">
                ...
                <tbody>
                <c:forEach items="${danhSach}" var="danhMuc" varStatus="status">
                    <tr>
                        ...
                        <td>
                            ...
                            <button class="btn btn-warning btn-sm" data-bs-toggle="modal"
                                    data-bs-target="#suaModal-${danhMuc.id}">
                                <i class="bi bi-pencil-square"></i> Sửa
                            </button>
                            <!-- Nút xóa -->
                            <form action="/danh-muc/delete" method="post" class="d-inline"
                    ...
                    <!-- Modal sửa -->
                    <div class="modal fade" id="suaModal-${danhMuc.id}" tabindex="-1"
                         aria-labelledby="suaModalLabel-${danhMuc.id}" aria-hidden="true">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="tenDanhMuc"
                                                   value="${danhMuc.tenDanhMuc}" required>
                                        </div>
                                    </div>
