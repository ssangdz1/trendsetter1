...
<div class="container mt-4">
    <h1 class="text-center mb-3">Quản lý Màu Sắc</h1>
        ...
        <div class="border p-3">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-striped text-center align-middle">
                    ...
                    <tbody>
                    <c:forEach items="${danhSach}" var="mauSac" varStatus="status">
                        <tr>
                            ...
                            <td>
                                ...
                                <button class="btn btn-warning btn-sm" data-bs-toggle="modal"
                                        data-bs-target="#suaModal-${mauSac.id}">
                                    <i class="bi bi-pencil-square"></i> Sửa
                                </button>
                                <!-- Nút xóa -->
                                <form action="/mau-sac/delete" method="post"
                        ...
                        <!-- Modal sửa màu sắc -->
                        <div class="modal fade" id="suaModal-${mauSac.id}" tabindex="-1"
                             aria-labelledby="suaModalLabel-${mauSac.id}" aria-hidden="true">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form action="/mau-sac/update" method="post">
                                            <input type="hidden" name="id" value="${mauSac.id}">
                                            <div class="mb-3">
                                                <label for="tenMauSac-${mauSac.id}" class="form-label">Tên Màu
                                                    Sắc</label>
                                                <input type="text" class="form-control" id="tenMauSac-${mauSac.id}"
                                                       name="tenMauSac" value="${mauSac.tenMauSac}" required>
                                            </div>
